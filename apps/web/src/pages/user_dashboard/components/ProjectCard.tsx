                ...
                <div className="space-y-3">
                    <div className="space-y-2">
                        ...
                        {project.description ? (
                            ...
                            <p className="line-clamp-2 text-sm text-slate-500 italic">No description</p>
                        )}
                    </div>
                ...
                <div className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className={`w-full rounded-xl border bg-slate-900/40 px-3 py-2 text-sm text-slate-100 outline-none transition focus:ring-2 focus:ring-indigo-400/20 ${
                                showInvalid
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="min-h-[80px] w-full resize-y rounded-xl border border-white/10 bg-slate-900/40 px-3 py-2 text-sm text-slate-100 outline-none transition focus:border-indigo-400/60 focus:ring-2 focus:ring-indigo-400/20"
                    ...
                    <div className="flex items-center justify-between text-xs text-slate-400">
                        <span>
                            {showInvalid ? "Title cannot be empty" : "Click save to apply changes"}
                        </span>
                    </div>
                    ...
                    <div className="flex gap-3">
                        <button
                            ...
                            className="flex-1 rounded-xl border border-white/10 bg-slate-900/40 px-3 py-2 text-sm text-slate-100 outline-none transition hover:border-white/20"
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            onClick={() => save()}
                            className={`flex-1 rounded-xl border px-3 py-2 text-sm text-slate-100 outline-none transition focus:ring-2 focus:ring-indigo-400/20 disabled:cursor-not-allowed disabled:opacity-50 ${
                                isSaving 
